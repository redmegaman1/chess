...
Z = 0
BOARDEXISTS = False
BROOK = pygame.image.load("img/black-rook.png")
BKNIGHT = pygame.image.load("img/black-knight.png")
BBISHOP = pygame.image.load("img/black-bishop.png")
BKING = pygame.image.load("img/black-king.png")
BQUEEN = pygame.image.load("img/black-queen.png")
BPAWN = pygame.image.load("img/black-pawn.png")
WROOK = pygame.image.load("img/white-rook.png")
WKNIGHT = pygame.image.load("img/white-knight.png")
WBISHOP = pygame.image.load("img/white-bishop.png")
WKING = pygame.image.load("img/white-king.png")
WQUEEN = pygame.image.load("img/white-queen.png")
WPAWN = pygame.image.load("img/white-pawn.png")
